.PHONY: help ensure-sccache build build-release test check clippy fmt fmt-check doc run install release release-dry-run release-prepare plugins-keygen plugins-build-rzn-tools-macos-arm64 plugins-verify plugins-validate-system-metadata sidecar-package sidecar-verify
