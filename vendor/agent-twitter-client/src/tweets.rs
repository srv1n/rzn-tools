...
pub async fn fetch_tweets(
    ...
    let (value, _headers) = request_api(
        &client.client,
        "https://x.com/i/api/graphql/YNXM2DGuE2Sff6a2JD3Ztw/UserTweets",
        headers,
        Method::GET,
        Some(json!({
            "variables": variables,
...
pub async fn fetch_list_tweets(
    ...
    let (value, _headers) = request_api(
        &client.client,
        "https://x.com/i/api/graphql/LFKj1wqHNTsEJ4Oq7TzaNA/ListLatestTweetsTimeline",
        headers,
        Method::GET,
        Some(json!({
            "variables": variables,
...
pub async fn create_quote_tweet(
    ...
    let mut variables = json!({
        "tweet_text": text,
        "dark_request": false,
        "attachment_url": format!("https://x.com/twitter/status/{}", quoted_tweet_id),
        "media": {
            "media_entities": [],
...
pub async fn fetch_liked_tweets(
    ...
    let (value, _headers) = request_api(
        &client.client,
        "https://x.com/i/api/graphql/YlkSUg4Czo2Zx7yRqpwDow/Likes",
        headers,
        Method::GET,
        Some(json!({
            "variables": variables,
